...
<!-- <div class="container"> -->
	<div class="row">
		...
		<div class="card-container col-md-3 col-md-offset-3">
			...
			<button class="btn btn-default" id="last_unit" title="Previous unit">&lt;&lt;</button>
			<button class="btn btn-default" id="last" title="Prevous Card">&lt;</button>
			<button class="btn btn-default" id="next" title="Next Card">&gt;</button>
			<button class="btn btn-default" id="next_unit" title="Next unit">&gt;&gt;</button>
